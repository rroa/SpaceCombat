...
namespace spacecombat
{
    ...
    public:
        ...
        virtual void OnFingerDown           ( SDL_Event* touchFingerEvent ){}
        virtual void OnFingerUp             ( SDL_Event* touchFingerEvent ){}
        virtual void OnFingerMotion         ( SDL_Event* touchFingerEvent ){}
